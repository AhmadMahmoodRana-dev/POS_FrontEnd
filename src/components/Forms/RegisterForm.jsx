...
export default function RegisterForm() {
  const { registerHandleChange, registerHandleSubmit , registerFormData } = useContext(Context);
  return (
    <>
      <div className="flex min-h-full flex-1 flex-col justify-center px-6 py-12 lg:px-8">
        <div className="sm:mx-auto sm:w-full sm:max-w-sm">
          ...
          />
          <h2 className="mt-10 text-center text-2xl/9 font-bold tracking-wide text-gray-900">
            REGISTER
          </h2>
        </div>

        <div className="mt-10 sm:mx-auto sm:w-full sm:max-w-sm">
          <form onSubmit={registerHandleSubmit} className="space-y-6">
            <div>
              <label
                htmlFor="email"
